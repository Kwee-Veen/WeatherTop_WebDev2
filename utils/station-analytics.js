...
export const stationAnalytics = {
    ...
    const latestReading = {      
      ...
      temperature:  await dataConversions.rounder(lastReading.temperature),
      temperatureFahrenheit: await dataConversions.rounder(temperatureFahrenheit),
      windSpeed:  await dataConversions.rounder(lastReading.windSpeed),
      windDirection:  await dataConversions.rounder(lastReading.windDirection),
      windDirectionCompass: windDirectionCompass,
      windSpeedBeaufort: windSpeedBeaufort,  
      pressure:  await dataConversions.rounder(lastReading.pressure),
      windChill: await dataConversions.rounder(windChill),
